...
* Accepts the data to create a new transaction with a provided Currency, CustomerId, AmountToConvert, AmountConverted, ConversionRate, IsShown, and TransactionDateTime.  Returns a new transaction including a unique transactionId generated by CurrencyPal.
  * if transaction could not be created return `TransactionNotValidException` 
...
## 7.3 Transactions currencyHistoryByCustomer GSI
```
...
isShown // boolean
```
## 7.4 Transactions historyByCustomer GSI
```
transactionId // string
currencyTo // string
currencyFrom // string
customer // partitionKey, string
amountToConvert // number
transactionDateTime // rangeKey, date
isShown // boolean
```
## 7.5 Transactions historyByCurrency GSI
```
transactionId // string
currencyTo // partitionKey, string
currencyFrom // string
